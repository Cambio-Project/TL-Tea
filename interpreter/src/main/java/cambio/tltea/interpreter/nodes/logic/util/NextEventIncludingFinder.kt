...
/**
 * Finds the next event from a time point, including the time point itself.
 */
class NextEventIncludingFinder(private val events: List<TimeEvent>, private val startEvent: TimeEvent) :
