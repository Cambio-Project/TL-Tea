...
/**
 * Finds the event before a time point, including the time point itself.
 */
class PreviousEventExcludingFinder(private val events: List<TimeEvent>, private val startEvent: TimeEvent) :
